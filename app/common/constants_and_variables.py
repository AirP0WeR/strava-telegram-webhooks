...
class AppConstants:
    ...
    QUERY_UPDATE_EVEN_CHALLENGES_DATA = "UPDATE strava_challenges SET even_challenges_data='{challenges_data}', updated=now() where athlete_id={athlete_id}"
    QUERY_UPDATE_ODD_CHALLENGES_DATA = "UPDATE strava_challenges SET odd_challenges_data='{challenges_data}', updated=now() where athlete_id={athlete_id}"
    ...
    QUERY_UPDATE_BOSCH_ODD_CHALLENGES_DATA = "UPDATE strava_challenges SET bosch_odd_challenges_data='{bosch_odd_challenges_data}', updated=now() where athlete_id={athlete_id}"
    QUERY_GET_ATHLETE_IDS_FROM_CHALLENGES = "select athlete_id from strava_challenges"
    QUERY_GET_EVEN_CHALLENGES_DATA = "select name, even_challenges, even_challenges_data from strava_challenges where even_challenges is not null"
    QUERY_GET_ODD_CHALLENGES_DATA = "select name, odd_challenges, odd_challenges_data from strava_challenges where odd_challenges is not null"
    QUERY_GET_BOSCH_EVEN_CHALLENGES_DATA = "select name, bosch_even_challenges, bosch_even_challenges_data from strava_challenges where bosch_even_challenges is not null"
    QUERY_GET_BOSCH_ODD_CHALLENGES_DATA = "select name, bosch_odd_challenges, bosch_odd_challenges_data from strava_challenges where bosch_odd_challenges is not null"
