...
class AppConstants(object):
    QUERY_FETCH_TOKEN_NAME_TELEGRAM_NAME = "select access_token, refresh_token, expires_at, name, telegram_username from strava_telegram_bot where active=true and athlete_id={athlete_id}"
